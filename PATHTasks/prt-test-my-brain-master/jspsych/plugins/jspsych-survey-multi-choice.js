  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choice" style="font-size:24px">' + trial.questions[i] + '</p>'
      );
      ...
      for (var j = 0; j < trial.options[i].length; j++) {
        ...
        var option_label = '<label class="' + plugin_id_name + '-text" style="font-size:16px">' + trial.options[i][j] + '</label>';
